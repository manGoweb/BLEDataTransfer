...
char* BDTMD5::make_digest(const unsigned char *digest, int len) /* {{{ */
{
 ...
 */
const void *BDTMD5::body(void *ctxBuf, const void *data, size_t size)
{
...
void BDTMD5::MD5Init(void *ctxBuf)
{
    MD5_CTX *ctx = (MD5_CTX*)ctxBuf;
    ctx->a = 0x67452301;
    ctx->b = 0xefcdab89;
...
void BDTMD5::MD5Update(void *ctxBuf, const void *data, size_t size)
{
    MD5_CTX *ctx = (MD5_CTX*)ctxBuf;
...
void BDTMD5::MD5Final(unsigned char *result, void *ctxBuf)
{
    MD5_CTX *ctx = (MD5_CTX*)ctxBuf;
    MD5_u32plus used, free;
...
unsigned char* BDTMD5::make_hash(char *arg)
{
    MD5_CTX context;
